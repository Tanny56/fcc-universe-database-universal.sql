...
--
-- Name: backhole; Type: TABLE; Schema: public; Owner: freecodecamp
--

CREATE TABLE public.backhole (
    backhole_id integer NOT NULL,
    gravity integer,
    galaxy_id integer,
...
ALTER TABLE public.backhole OWNER TO freecodecamp;

--
-- Name: backhole_backhole_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.backhole_backhole_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.backhole_backhole_id_seq OWNER TO freecodecamp;

--
-- Name: backhole_backhole_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.backhole_backhole_id_seq OWNED BY public.backhole.backhole_id;
...
--
-- Name: backhole backhole_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.backhole ALTER COLUMN backhole_id SET DEFAULT nextval('public.backhole_backhole_id_seq'::regclass);
...
--
-- Name: backhole_backhole_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.backhole_backhole_id_seq', 1, false);
...
--
-- Name: backhole backhole_pkey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.backhole
    ADD CONSTRAINT backhole_pkey PRIMARY KEY (backhole_id);
